...
2. **生成人物档案**：创建 `00-人物档案.md`，使用 [character-template.md](../guides/character-template.md) **五类角色模板**，参考 [character-building.md](../guides/character-building.md) 创建主角、重要角色、次要角色、重要反派、次要反派档案。**人物档案必须详细**：每个角色的性格核心、致命缺陷、说话风格/口头禅、恐惧/弱项、背景故事都要具体到可以直接指导写作的程度
3. **生成大纲**：创建 `01-大纲.md`，使用 [outline-template.md](../guides/outline-template.md) 模板，参考 [plot-structures.md](../guides/plot-structures.md) 填入完整的章节规划。**大纲必须整合四大进阶体系**：
   - 全局时间线体系：章节-日期-时间段对照表
   - 刀子伏笔布局体系：伏笔追踪索引
   - 角色/剧情进阶条件体系：人物成长节点规划
   - 专属成长体系树：功法修为树/科技研发树层级
   **大纲必须以人物驱动情节**，参照 `00-人物档案.md`，确保情节服务于人物成长弧线
...
向用户展示规划摘要（小说名称、总章数、目标字数、五类主要人物、四大体系概览）并请求确认。
